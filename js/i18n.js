...
(function () {
  ...
  var translations = {
    es: {
      ...
      'house.bannerBtn': 'Quiero entrenar',
      ...
      'house.step1.h4': 'Sumate a entrenar',
      'house.step1.p': 'Traé tu equipo (hasta 3) a practicar con nosotros.',
      'house.step2.h4': 'Entrená en la casa',
      'house.step2.p': 'Práctica intensiva junto a los equipos que viven en la casa, hasta el 7 de noviembre.',
    ...
    en: {
      ...
      'about.p2': 'Uruguay competes within the <strong>South America South</strong> site of the Latin American Regional, alongside teams from Argentina and Paraguay, a path that — as in the rest of the continent — leads to the World Finals.',
      ...
      'house.bannerBtn': 'I want to train',
      ...
      'house.feature3.p': 'A training plan with a single aim: qualify the first Uruguayan team for an ICPC World Finals.',
      'house.step1.h4': 'Come train with us',
      'house.step1.p': 'Bring your team (up to 3) to practice with us.',
      'house.step2.h4': 'Train at the house',
      'house.step2.p': 'Intensive practice alongside the teams living in the house, through November 7th.',
      'house.step3.h4': 'Represent Uruguay',
      'house.step3.p': 'Arrive at the ICPC Latin American Regional in the best possible shape.',
      ...
      'house.phase1.p': 'Bringing everyone to a common level, building training routines, and settling into each team’s working dynamic.',
